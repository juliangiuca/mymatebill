module AccountsHelper
  ...
  #
  # Use this to wrap view elements that the account can't access.
  # !! Note: this is an *interface*, not *security* feature !!
  # You need to do all access control at the controller level.
  #
  # Example:
  # <%= if_authorized?(:index,   Account)  do link_to('List all accounts', accounts_path) end %> |
  # <%= if_authorized?(:edit,    @account) do link_to('Edit this account', edit_account_path) end %> |
  # <%= if_authorized?(:destroy, @account) do link_to 'Destroy', @account, :confirm => 'Are you sure?', :method => :delete end %> 
  #
  #
  ...
  #
  # Link to account's page ('accounts/1')
  #
  ...
  #
  #   link_to_account @account, :content_text => 'Your account page'
  #   # => <a href="/accounts/3" title="barmy" class="nickname">Your account page</a>
  #
  ...
  #
  # Link to the current account's page (using link_to_account) or to the login page
